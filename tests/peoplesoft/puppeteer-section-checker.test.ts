...
import { PuppeteerSectionChecker } from '../../src/peoplesoft/workflow/puppeteer-section-checker.js';

describe('PuppeteerSectionChecker class-list parsing', () => {
  it('keeps each live-style class row status and schedule isolated', () => {
    ...
    const checker = new PuppeteerSectionChecker();
